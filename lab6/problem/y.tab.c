...
{
       0,    34,    34,    37,    38,    42,    43,    47,    48,    49,
      52,    55,    56,    57,    58,    74,    75,    79,    84,    85
};
#endif
...
static const char *const yytname[] =
{
  ...
  "RB", "LCB", "RCB", "SC", "COMA", "VAR", "EQ", "OP", "INT", "CHAR",
  "FLOAT", "DOUBLE", "$accept", "prm", "BODY", "DECLARATION_STATEMENTS",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* prm: HEADER MAIN_TYPE MAIN LB RB LCB BODY RCB  */
#line 34 "project.y"
                                                   {
							printf("\n parsing successful\n");
						   }
...
#line 1216 "y.tab.c"
  ...
  case 8: /* DECLARATION_STATEMENT: DATA_TYPE VAR_LIST SC  */
#line 48 "project.y"
                                             {}
#line 1222 "y.tab.c"
    break;
...
#line 1238 "y.tab.c"
  ...
  case 11: /* PROGRAM_STATEMENT: VAR EQ A_EXPN SC  */
#line 55 "project.y"
                                     {	expn_type=-1;	}
#line 1244 "y.tab.c"
    break;
